...
//! \file
//! \brief LinearPrimitiveImpl class

#ifndef _LINEARPRIM_H
#define _LINEARPRIM_H
...
class EXPCL_FRACTALSPLINE LinearPrimitiveImpl : public PrimitiveImpl
{
public:
   LinearPrimitiveImpl()
   {
      LinearExtrusionPath.SetLevelOfDetail( iLevelOfDetail );
   }
   ...
   virtual void SetShear( const float fNewShear ); //!< Set Sheer
   virtual void SetTopSizeX( const float fNewSheer ); //!< Set Sheer
...
protected:
   ...
   LinearExtrusionPathClass LinearExtrusionPath;
