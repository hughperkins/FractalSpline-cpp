...
//! \file
//! \brief PrimitiveRing class function definitions
...
namespace FractalSpline
{
   ...
   PrimitiveRing::PrimitiveRing( RendererCallbacksClass *pNewRendererCallbacks )
   {
      pPrimitive = new PrimitiveRingImpl( pNewRendererCallbacks );
   }
