...
#ifndef _PRIMITIVEBOXINTERFACE_H
#define _PRIMITIVEBOXINTERFACE_H
...
class EXPCL_FRACTALSPLINE PrimitiveBoxInterface
{
public:
   //PrimitiveBox();
   //PrimitiveBoxInterface( RendererCallbacksClass *pNewRendererCallbacks );

//   virtual void Render() = 0;
};
}

#endif // _PRIMITIVEBOXINTERFACE_H
