...
//! \file
//! \brief PrimitivePrism class function definitions
...
namespace FractalSpline
{
   ...
   PrimitivePrism::PrimitivePrism( RendererCallbacksClass *pNewRendererCallbacks )
   {
      pPrimitive = new PrimitivePrismImpl( pNewRendererCallbacks );
   }

   PrimitivePrism::~PrimitivePrism()
   {
      delete( pPrimitive );
   }
}
