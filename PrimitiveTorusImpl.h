...
#ifndef _PRIMITIVETORUSIMPL_H
#define _PRIMITIVETORUSIMPL_H
...
{
//! PrimitiveTorus will render a box to OpenGL, applying various advanced transformations, such as twist
class EXPCL_FRACTALSPLINE PrimitiveTorusImpl : public RotationalPrimitiveImpl
{
public:
   PrimitiveTorusImpl( RendererCallbacksClass *pNewRendererCallbacks );
